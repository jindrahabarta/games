      ...
      <section className="p-10 lg:w-80 w-full bg-orange-200 rounded-xl shadow-slex-col m shadow-slate-300 min-h-96 max-h-96 overflow-hidden overflow-y-auto">
        ...
        <div className="flex flex-col gap-3 w-full ">
          <Disclosure>
            ...
            >
              <Disclosure.Panel className="bg-orange-300 bg-opacity-50  p-2 rounded-lg">
                Tento upgrade ti přidá +1 cpc. Což znamená že ti při jednom
                kliku na sušenku, přibyde tolik sušenek, kolik máš cpc.
              </Disclosure.Panel>
            </Transition>
          </Disclosure>
          <Disclosure>
            ...
            >
              <Disclosure.Panel className="bg-orange-300 bg-opacity-50  p-2 rounded-lg">
                Tento upgrade ti přidá +2 cpc. Což znamená že ti při jednom
                kliku na sušenku, přibyde tolik sušenek, kolik máš cpc.
              </Disclosure.Panel>
            </Transition>
          </Disclosure>
          <Disclosure>
            ...
            >
              <Disclosure.Panel className="bg-orange-300 bg-opacity-50  p-2 rounded-lg">
                Tento upgrade ti přidá +1 cps. Což znamená že ti za jednu
                sekundu přibyde tolik sušenek, kolik máš cps.
              </Disclosure.Panel>
            </Transition>
          </Disclosure>
          <Disclosure>
            ...
            >
              <Disclosure.Panel className="bg-orange-300 bg-opacity-50  p-2 rounded-lg">
                Tento upgrade ti přidá +2 cps. Což znamená že ti za jednu
                sekundu přibyde tolik sušenek, kolik máš cps.
              </Disclosure.Panel>
            </Transition>
          </Disclosure>
          ...
          <ul className="flex flex-col gap-3 w-72">
            {cookies >= 20 ? (
              ...
              <div className="invisible">
                <Uprage onClick={lvl1} image="" level="1" cpx="cpc"></Uprage>
              </div>
            )}
            {cookies >= 50 && (
              <Uprage
