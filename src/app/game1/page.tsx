            ...
            <AnimatePresence>
              {showRules && (
                <motion.div
                  ...
                  animate={{ width: [0, 300, 300], height: [0, 0, 350] }}
                  exit={{
                    width: [300, 300, 0],
                    height: [350, 0, 0],
                    padding: 0,
                ...
                >
                  <h1 className="font-pixelify">How to play</h1>
                  <p>
                    The rules of the game "Ten Questions": The player draws 10
                    questions sequentially and answers each one. The player has
                    30 seconds to respond. Answers must be quick and honest.
                    Failure to respond in time or providing unclear answers
                    results in losing a point. Questions can be of any kind. The
                    goal is to score as many points as possible. The player with
                    the highest score after 10 questions wins.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
